...
cv_responsible.value as responsible
...
left join custom_values cv_responsible on (cv_responsible.customized_id=i.id and cv_responsible.custom_field_id=(select id from custom_fields where name='responsible'))
